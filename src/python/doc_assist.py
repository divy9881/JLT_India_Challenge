...
if __name__ == '__main__':
    ...
    # main_json_object(os.getcwd() + '\\files\\templates\\Template.docx', os.getcwd() + '\\files\\json\\demo.json')
    # sys.stdout.flush()

    main_xml_object(os.getcwd() + '\\files\\templates\\Template.docx', os.getcwd() + '\\files\\xml\\demo.xml')
    sys.stdout.flush()
